"""S3 module.
taken from https://raw.githubusercontent.com/sdv-dev/SDGym/main/sdgym/s3.py
"""
...
def write_file(data_contents, path, aws_key, aws_secret):
    ...
    if is_s3_path(path):
        ...
        s3.put_object(Bucket=bucket_name, Key=key, Body=data_contents, ContentEncoding=content_encoding)
    else:
